res <-readRDS("/loc/no-backup/Lynn/cts_measurements_v1.2/Case-Control/res.rds") # only CD4+
meta <-readRDS("/loc/no-backup/Lynn/cts_measurements_v1.2/Case-Control/meta.rds")
cd4_counts <- readRDS("/loc/no-backup/Lynn/cts_measurements_v1.2/Case-Control/cd4_counts.rds")
...
#### case-control
orig <- read.csv("/loc/no-backup/Lynn/cts_measurements_v1.2/Case-Control/PTID_map_case_control.csv", header=T, sep=",")
